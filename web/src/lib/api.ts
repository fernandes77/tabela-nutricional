...
// Always use localhost:3000 for the API (Go server must be running during build)
const API_URL = 'http://localhost:3000';

export async function fetchFoods(source: 'taco' | 'tbca' | 'both' = 'both'): Promise<Food[]> {
...
export function formatNutrientValue(value: number | null | undefined, multiplier: number = 1): string {
